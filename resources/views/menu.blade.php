...
<body>
    <header>
        <div role="navigation">
            <nav class="navbar navbar-nav navbar-expand-lg navbar-light" style="background-color: #E7E9EB;">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="http://localhost:8888/login">Iniciar Sesión</a>
                                <a class="dropdown-item" href="http://localhost:8888/logout">Cerrar Sesión</a>
                            </div>
                        </li>
                    </ul>
                </div>
